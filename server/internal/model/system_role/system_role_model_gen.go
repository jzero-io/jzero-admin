...
type (
	systemRoleModel interface {
		...
		FindOne(ctx context.Context, id int64) (*SystemRole, error)
...
func (m *defaultSystemRoleModel) Delete(ctx context.Context, id int64) error {
...
func (m *defaultSystemRoleModel) FindOne(ctx context.Context, id int64) (*SystemRole, error) {
