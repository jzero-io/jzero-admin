...
type (
	systemUserRoleModel interface {
		...
		FindOne(ctx context.Context, id int64) (*SystemUserRole, error)
...
func (m *defaultSystemUserRoleModel) Delete(ctx context.Context, id int64) error {
...
func (m *defaultSystemUserRoleModel) FindOne(ctx context.Context, id int64) (*SystemUserRole, error) {
