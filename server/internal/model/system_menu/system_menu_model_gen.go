...
type (
	systemMenuModel interface {
		...
		FindOne(ctx context.Context, id uint64) (*SystemMenu, error)
...
func (m *defaultSystemMenuModel) Delete(ctx context.Context, id uint64) error {
...
func (m *defaultSystemMenuModel) FindOne(ctx context.Context, id uint64) (*SystemMenu, error) {
