...
type (
	systemRoleMenuModel interface {
		...
		FindOne(ctx context.Context, id int64) (*SystemRoleMenu, error)
...
func (m *defaultSystemRoleMenuModel) Delete(ctx context.Context, id int64) error {
...
func (m *defaultSystemRoleMenuModel) FindOne(ctx context.Context, id int64) (*SystemRoleMenu, error) {
